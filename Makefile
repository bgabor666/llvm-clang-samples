...
LLVM_SRC_PATH := /home/bgabor/work/ARM/switch-optimization/llvm
...
LLVM_BUILD_PATH := /home/bgabor/work/ARM/switch-optimization/release-build
...
all: make_builddir \
	...
	$(BUILDDIR)/function_type_extractor \
...
$(BUILDDIR)/function_type_extractor: $(SRC_CLANG_DIR)/function_type_extractor.cpp
	$(CXX) $(CXXFLAGS) $(LLVM_CXXFLAGS) $(CLANG_INCLUDES) $^ \
		$(CLANG_LIBS) $(LLVM_LDFLAGS) -o $@
